  ...
  return (
    <div className="h-screen w-screen bg-white">
      <div className="grid h-full grid-cols-1 md:grid-cols-2">
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <form className="mt-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                disabled={!agree}
                className="inline-flex w-full items-center justify-center rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200 disabled:cursor-not-allowed disabled:opacity-60"
              >
                Sign Up
              </button>
              ...
              <div className="flex items-center justify-between pt-2 text-sm text-neutral-500">
                ...
                <a href="/" className="rounded-xl bg-blue-600 px-5 py-2 font-medium text-white hover:bg-blue-700">
                  Login
                </a>
              </div>
            </form>
        ...
        {/* Right: Welcome panel with image (same design as login) */}
